    ...
    <>
          ...
          <div style={{ maxWidth: '780px' }}>
            <div style={up(0.4)}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '18px', marginBottom: '28px' }}>
                ...
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#B8D48A', letterSpacing: '0.32em', textTransform: 'uppercase' }}>A Empresa · Belém, Pará</span>
              </div>
            </div>
            <div style={up(0.62)}>
              <h1 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(48px, 6vw, 84px)', fontWeight: 300, color: '#F6F4EF', lineHeight: 1.06, letterSpacing: '-0.02em', marginBottom: '28px' }}>Sobre a<br />AgroVisão</h1>
            </div>
            <div style={up(0.84)}>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '17px', fontWeight: 400, color: 'rgba(246,244,239,0.78)', lineHeight: 1.75, maxWidth: '560px' }}>Transformando conhecimento técnico em desenvolvimento sustentável para a agricultura amazônica.</p>
            </div>
          </div>
        </div>
        ...
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div className="about-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '108px', alignItems: 'center' }}>
            ...
            <div>
              ...
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase', display: 'block', marginBottom: '30px' }}>Quem Somos</span>
              <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(36px, 3.6vw, 52px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.2, letterSpacing: '-0.015em', marginBottom: '32px', textWrap: 'pretty' }}>Uma consultoria dedicada ao desenvolvimento sustentável da Amazônia</h2>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', fontWeight: 400, color: '#4a4a44', lineHeight: 1.92, marginBottom: '22px' }}>A AgroVisão é uma consultoria técnica especializada em desenvolvimento rural, regularização fundiária e gestão ambiental na Amazônia Legal. Atuamos ao lado de produtores rurais, associações, cooperativas, ONGs e instituições públicas, oferecendo soluções completas e alinhadas às exigências legais vigentes.</p>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', fontWeight: 400, color: '#4a4a44', lineHeight: 1.92, marginBottom: '48px' }}>Nossa equipe multidisciplinar combina formação técnica de excelência com profundo conhecimento do território amazônico e das políticas públicas voltadas ao desenvolvimento da agricultura familiar e empresarial.</p>
              <div className="stats-row" style={{ display: 'flex', gap: '48px' }}>
                <div>
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '48px', fontWeight: 300, color: '#315B2C', lineHeight: 1, marginBottom: '8px' }}>15<span style={{ fontSize: '28px', color: '#6F8F3A' }}>+</span></div>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.18em', textTransform: 'uppercase', lineHeight: 1.5 }}>Anos de<br />Experiência</div>
                </div>
                <div style={{ width: '1px', background: 'rgba(49,91,44,0.12)' }} />
                <div>
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '48px', fontWeight: 300, color: '#315B2C', lineHeight: 1, marginBottom: '8px' }}>500<span style={{ fontSize: '28px', color: '#6F8F3A' }}>+</span></div>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.18em', textTransform: 'uppercase', lineHeight: 1.5 }}>Projetos<br />Concluídos</div>
                </div>
                <div style={{ width: '1px', background: 'rgba(49,91,44,0.12)' }} />
                <div>
                  <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '48px', fontWeight: 300, color: '#315B2C', lineHeight: 1, marginBottom: '8px' }}>12</div>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.18em', textTransform: 'uppercase', lineHeight: 1.5 }}>Estados<br />Atendidos</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-mission" style={{ background: '#F5F8F3', padding: '128px 0', borderTop: '1px solid rgba(49,91,44,0.08)', borderBottom: '1px solid rgba(49,91,44,0.08)' }}>
        <div className="container" style={{ maxWidth: '960px', margin: '0 auto', padding: '0 84px', textAlign: 'center' }}>
          ...
          <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase', display: 'block', marginBottom: '48px' }}>Nossa Missão</span>
          <div style={{ fontFamily: 'var(--font-sans)', fontSize: 'clamp(32px, 4vw, 54px)', fontWeight: 500, color: '#1a1a18', lineHeight: 1.25, letterSpacing: '-0.01em', marginBottom: '40px', textWrap: 'pretty' }}>&ldquo;Elaborando sonhos no presente,<br />construindo o amanhã<br />a partir da melhor Visão.&rdquo;</div>
          <div style={{ width: '40px', height: '1px', background: '#6F8F3A', margin: '0 auto 20px' }} />
          <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.22em', textTransform: 'uppercase' }}>AgroVisão — Consultoria Agrícola</span>
        </div>
      </section>
      ...
      <section className="section-what" style={{ background: '#FFFFFF', padding: '148px 0' }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '72px' }}>
            <div>
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase', display: 'block', marginBottom: '16px' }}>Serviços</span>
              <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(38px, 4.5vw, 60px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.08, letterSpacing: '-0.02em' }}>O Que<br />Fazemos</h2>
            </div>
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '14.5px', fontWeight: 400, color: '#555550', lineHeight: 1.8, maxWidth: '380px', marginBottom: '6px' }}>Soluções técnicas integradas para o desenvolvimento rural sustentável em toda a Amazônia Legal.</p>
          </div>
          <div className="services-grid-4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px' }}>
            {SERVICES.map((svc, idx) => (
              ...
              >
                ...
                <h3 style={{ fontFamily: "'Barlow', sans-serif", fontSize: '22px', fontWeight: 500, color: '#1a1a18', lineHeight: 1.25, marginBottom: '12px' }}>{svc.title}</h3>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 400, color: '#666660', lineHeight: 1.78, flex: 1, marginBottom: '20px' }}>{svc.desc}</p>
                <a href="/" style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', fontWeight: 600, color: '#315B2C', textDecoration: 'none', letterSpacing: '0.1em', textTransform: 'uppercase', display: 'inline-flex', alignItems: 'center', gap: '6px', opacity: 0.85 }}>
                  Saiba mais
      ...
      <section className="section-process" style={{ background: '#F8F7F3', padding: '128px 0', borderTop: '1px solid rgba(49,91,44,0.08)' }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div style={{ marginBottom: '80px' }}>
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase', display: 'block', marginBottom: '16px' }}>Metodologia</span>
            <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(38px, 4.5vw, 60px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.08, letterSpacing: '-0.02em' }}>Como Trabalhamos</h2>
          </div>
          <div className="process-steps" style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '24px' }}>
            {PROCESS_STEPS.map((step) => (
              <div key={step.num} style={{ borderTop: '1.5px solid #B8D48A', paddingTop: '24px', position: 'relative' }}>
                ...
                <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '40px', fontWeight: 300, color: '#315B2C', lineHeight: 1, marginBottom: '14px' }}>{step.num}</div>
                <h3 style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', fontWeight: 700, color: '#1a1a18', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '10px' }}>{step.title}</h3>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '12.5px', fontWeight: 400, color: '#666660', lineHeight: 1.72 }}>{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div className="diff-sticky-grid" style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: '108px', alignItems: 'start' }}>
            <div style={{ position: 'sticky', top: '120px' }}>
              <div style={{ width: '34px', height: '1px', background: '#315B2C', marginBottom: '18px' }} />
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase', display: 'block', marginBottom: '28px' }}>Nossos Diferenciais</span>
              <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(38px, 4vw, 56px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.12, letterSpacing: '-0.015em', marginBottom: '28px' }}>Por que escolher a AgroVisão</h2>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '14.5px', fontWeight: 400, color: '#4a4a44', lineHeight: 1.88 }}>Mais de 15 anos consolidando nossa presença no setor agropecuário da Amazônia com resultados técnicos comprovados.</p>
            </div>
            <div className="diff-grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0 }}>
              {DIFFERENTIALS.map((diff, idx) => {
                ...
                return (
                  ...
                  >
                    <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '13px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '14px' }}>{diff.num}</div>
                    <h3 style={{ fontFamily: "'Barlow', sans-serif", fontSize: '26px', fontWeight: 400, color: '#1a1a18', lineHeight: 1.25, marginBottom: '12px' }}>{diff.title}</h3>
                    <p style={{ fontFamily: 'var(--font-sans)', fontSize: '13.5px', fontWeight: 400, color: '#666660', lineHeight: 1.78 }}>{diff.desc}</p>
                  </div>
                )
              })}
            </div>
      ...
      <section className="section-gallery" style={{ background: '#F5F8F3', padding: '0 0 0 0', borderTop: '1px solid rgba(49,91,44,0.08)' }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '128px 84px 0' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '56px' }}>
            <div>
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase', display: 'block', marginBottom: '16px' }}>Campo</span>
              <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(38px, 4.5vw, 58px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.08, letterSpacing: '-0.02em' }}>Nossa Experiência<br />em Campo</h2>
            </div>
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '14px', fontWeight: 400, color: '#555550', lineHeight: 1.8, maxWidth: '360px', marginBottom: '8px' }}>Atuamos em toda a extensão da Amazônia Legal, de comunidades rurais a grandes propriedades agropecuárias.</p>
          </div>
        </div>
      ...
      <section className="section-cta" style={{ background: '#FFFFFF', padding: '148px 0', borderTop: '1px solid rgba(49,91,44,0.08)' }}>
        <div className="cta-grid container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          <div>
            <div style={{ width: '34px', height: '1px', background: '#315B2C', marginBottom: '18px' }} />
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase', display: 'block', marginBottom: '32px' }}>Próximo Passo</span>
            <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(38px, 4.5vw, 62px)', fontWeight: 300, color: '#1a1a18', lineHeight: 1.1, letterSpacing: '-0.02em', textWrap: 'pretty' }}>
              Vamos construir seu<br />próximo projeto<br />
              <span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: 'clamp(33px, 3.9vw, 53px)', fontStyle: 'normal' }}>juntos</span>.
            </h2>
          </div>
          <div>
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', fontWeight: 400, color: '#4a4a44', lineHeight: 1.88, marginBottom: '48px' }}>Nossa equipe está pronta para avaliar seu projeto sem custo e indicar o melhor caminho técnico para regularizar, licenciar e desenvolver sua propriedade na Amazônia Legal.</p>
        ...
        >
          <div className="modal" style={{ background: '#FFFFFF', borderRadius: '14px', width: 'min(720px, 100%)', maxHeight: '88vh', overflowY: 'auto', boxShadow: '0 32px 100px rgba(0,0,0,0.25)' }}>
            <div style={{ padding: '36px 44px 24px', borderBottom: '1px solid rgba(49,91,44,0.08)', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', position: 'sticky', top: 0, background: '#FFFFFF', zIndex: 1, borderRadius: '14px 14px 0 0' }}>
              <div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase', marginBottom: '10px' }}>
                  Consultoria Gratuita
                </div>
                <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: '30px', fontWeight: 400, color: '#1a1a18', lineHeight: 1.2 }}>
            ...
            {mSts !== 'success' ? (
              <form onSubmit={submitForm} style={{ padding: '32px 44px 44px' }}>
                <div className="form-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                  <div>
                    <label style={{ display: 'block', fontFamily: 'var(--font-sans)', fontSize: '10px', fontWeight: 600, color: '#555550', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '8px' }}>
                    ...
                    <input
                      ...
                      style={{ width: '100%', padding: '12px 14px', border: '1px solid rgba(49,91,44,0.2)', borderRadius: '8px', fontFamily: 'var(--font-sans)', fontSize: '14px', color: '#1a1a18', background: '#FAFAF9', outline: 'none' }}
                    />
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', padding: '16px', background: '#F8F7F3', borderRadius: '8px', marginBottom: '28px' }}>
                  ...
                  />
                  <label htmlFor="a-prv" style={{ fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 400, color: '#555550', lineHeight: 1.65, cursor: 'pointer' }}>
              ...
              <div style={{ padding: '64px 44px', textAlign: 'center' }}>
                ...
                <h3 style={{ fontFamily: "'Barlow', sans-serif", fontSize: '34px', fontWeight: 400, color: '#1a1a18', marginBottom: '16px' }}>
                  Solicitação Enviada!
                </h3>
