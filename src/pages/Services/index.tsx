    ...
    <>
          ...
          <div style={{ maxWidth: '800px' }}>
            <div style={up(0.45)}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '18px', marginBottom: '28px' }}>
                ...
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '13.5px', fontWeight: 600, color: '#B8D48A', letterSpacing: '0.32em', textTransform: 'uppercase', textShadow: '0 1px 2px rgba(0,0,0,0.4)' }}>Nossos Serviços</span>
              </div>
            </div>
            <div style={up(0.65)}>
              ...
              {svc.reversed ? (
                <>
                  <div className="service-panel" style={{ background: svc.panelBg, borderRadius: '14px', padding: '40px', display: 'flex', flexDirection: 'column', gap: '24px', order: -1 }}>
                    {svc.items.map((item) => (
                      <div key={item.title} style={{ display: 'flex', gap: '16px' }}>
                        ...
                        <div>
                          <h3 style={{ fontFamily: 'var(--font-sans)', fontSize: '17px', fontWeight: 700, color: '#1a1a18', marginBottom: '6px' }}>{item.title}</h3>
                          <p style={{ fontFamily: 'var(--font-sans)', fontSize: '16px', fontWeight: 400, color: '#666660', lineHeight: 1.6 }}>{item.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                  <div>
                    ...
                    <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: '45px', fontWeight: 400, color: '#1a1a18', lineHeight: 1.15, letterSpacing: '-0.015em', marginBottom: '24px' }} dangerouslySetInnerHTML={{ __html: svc.title }} />
                    <p style={{ fontFamily: 'var(--font-sans)', fontSize: '18px', fontWeight: 400, color: '#555550', lineHeight: 1.85, marginBottom: '32px' }}>{svc.desc}</p>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                      <a
                        href="#"
                        onClick={(e) => { e.preventDefault(); openModal() }}
                        style={{ display: 'inline-block', padding: '14px 32px', background: '#315B2C', color: '#F6F4EF', fontFamily: 'var(--font-sans)', fontSize: '14.5px', fontWeight: 600, letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '8px', transition: 'background 0.25s', textAlign: 'center' }}
                        onMouseEnter={(e) => { e.currentTarget.style.background = '#254822' }}
                        onMouseLeave={(e) => { e.currentTarget.style.background = '#315B2C' }}
                      >
                        {svc.btn}
                      ...
                      <a
                        ...
                        style={{ display: 'inline-block', padding: '13px 32px', color: '#315B2C', fontFamily: 'var(--font-sans)', fontSize: '14.5px', fontWeight: 600, letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '8px', border: '1px solid rgba(49,91,44,0.28)', transition: 'border-color 0.25s', textAlign: 'center' }}
      ...
      <section style={{ background: '#315B2C', padding: '128px 0' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 84px', textAlign: 'center' }}>
          ...
          <span style={{ fontFamily: 'var(--font-sans)', fontSize: '13.5px', fontWeight: 500, color: '#B8D48A', letterSpacing: '0.24em', textTransform: 'uppercase', display: 'block', marginBottom: '28px' }}>
            Pronto para começar?
          </span>
          <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(41px, calc(4.5vw + 3px), 65px)', fontWeight: 300, color: '#F6F4EF', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '24px', textWrap: 'pretty' }}>
            ...
            <span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: 'clamp(36px, calc(3.9vw + 3px), 56px)', fontStyle: 'normal' }}>projeto</span>.
          </h2>
            ...
            {mSts !== 'success' ? (
              <form onSubmit={submitForm} style={{ padding: '32px 44px 44px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', padding: '16px', background: '#F8F7F3', borderRadius: '8px', marginBottom: '28px' }}>
                  ...
                  />
                  <label htmlFor="s-prv" style={{ fontFamily: 'var(--font-sans)', fontSize: '16px', fontWeight: 400, color: '#555550', lineHeight: 1.65, cursor: 'pointer' }}>
