          ...
          <div style={{ maxWidth: '700px', marginTop: '40px' }}>
            <div style={up(0.4)}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '28px' }}>
                ...
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '10px', fontWeight: 600, color: '#B8D48A', letterSpacing: '0.32em', textTransform: 'uppercase', textShadow: '0 1px 2px rgba(0,0,0,0.4)' }}>
            ...
            <div style={up(0.84)}>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15.5px', fontWeight: 400, color: 'rgba(246,244,239,0.85)', lineHeight: 1.85, maxWidth: '520px', marginBottom: '40px', textShadow: '0 1px 2px rgba(0,0,0,0.35)' }}>
              ...
              <div className="hero-badges" style={{ display: 'flex', alignItems: 'center', gap: '24px', flexWrap: 'wrap' }}>
                {['Estratégia', 'Planejamento', 'Gestão', 'Resultados'].map((badge) => (
                  <div key={badge} style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
                    ...
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: 'rgba(246,244,239,0.85)' }}>
                      {badge}
                    </span>
                  </div>
                ))}
