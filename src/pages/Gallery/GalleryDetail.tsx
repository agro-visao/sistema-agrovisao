        ...
        <div className={styles.section}>
          <div className={styles.grid}>
            {!loaded ? (
              ...
              <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '100px 0' }}>
                <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '23px', fontWeight: 500, color: '#1a1a18', marginBottom: '8px' }}>Nenhuma imagem encontrada</div>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', color: '#777772', marginBottom: '24px' }}>Este projeto não possui imagens registradas.</p>
                <button
              ...
              <>
                ...
                <div style={{ gridColumn: '1 / -1', marginBottom: '48px' }}>
                  {selectedImage && (
                    <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '40px', alignItems: 'start' }}>
                      ...
                      <div>
                        <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '12px' }}>
                          {project?.categoryLabel}
                        </div>
                        {briefDescription && (
                          <p style={{ fontFamily: "'Barlow', sans-serif", fontSize: '20px', fontWeight: 400, color: '#1a1a18', lineHeight: 1.55, marginBottom: '16px', letterSpacing: '-0.005em' }}>
                            {briefDescription}
                          </p>
                        )}
                        <p style={{ fontFamily: 'var(--font-sans)', fontSize: '14px', fontWeight: 400, color: '#888882', lineHeight: 1.8, marginBottom: '28px' }}>
                ...
                <div style={{ gridColumn: '1 / -1' }}>
                  <div style={{ marginBottom: '24px' }}>
                    <div style={{ fontFamily: 'var(--font-sans)', fontSize: '12px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '16px' }}>
                ...
                {fullDescription && (
                  <div style={{ gridColumn: '1 / -1', marginTop: '48px', maxWidth: '780px' }}>
                    ...
                    {fullDescription.split(/\n{2,}/).map((paragraph, i) => (
                      <p
                        key={i}
                        style={{ fontFamily: 'var(--font-sans)', fontSize: '16px', fontWeight: 400, color: '#555550', lineHeight: 1.9, marginBottom: '16px', whiteSpace: 'pre-line' }}
                      >
                        {paragraph}
                      </p>
                    ))}
