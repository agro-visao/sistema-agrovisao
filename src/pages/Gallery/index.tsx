          ...
          <div className={styles.grid}>
            {!loaded ? (
              <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '100px 0' }}>
                ...
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', color: '#888882' }}>Carregando galeria...</p>
              </div>
            ) : loadError ? (
              <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '100px 0' }}>
                <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '23px', fontWeight: 500, color: '#DD8758', marginBottom: '8px' }}>Erro ao carregar</div>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', color: '#777772', marginBottom: '24px' }}>Não foi possível carregar a galeria. Tente novamente em instantes.</p>
                <button
                  onClick={retry}
                  style={{ display: 'inline-block', padding: '12px 28px', background: '#315B2C', color: '#F6F4EF', fontFamily: 'var(--font-sans)', fontSize: '12px', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '8px', border: 'none', cursor: 'pointer', transition: 'background 0.22s' }}
              ...
              <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '100px 0' }}>
                <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '23px', fontWeight: 500, color: '#1a1a18', marginBottom: '8px' }}>Nenhum projeto encontrado</div>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', color: '#777772' }}>Tente ajustar sua busca.</p>
              </div>
            ) : (
                ...
                {filtered.map((g) => (
                  ...
                  >
                    <div className={styles.cardImageWrap}>
                      ...
                      <div style={{ position: 'absolute', top: '10px', left: '10px', background: '#315B2C', color: '#F6F4EF', padding: '4px 10px', borderRadius: '4px', fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', zIndex: 1 }}>
                    ...
                    <div className={styles.cardBody}>
                      ...
                      {g.brief && (
                        <p style={{ fontFamily: 'var(--font-sans)', fontSize: '14px', fontWeight: 400, color: '#777772', lineHeight: 1.7, marginTop: '8px' }}>
                          {g.brief}
                        </p>
                      )}
                      <div style={{ marginTop: '14px' }}>
                        <span
                          style={{ fontFamily: 'var(--font-sans)', fontSize: '14px', fontWeight: 500, color: '#315B2C', textDecoration: 'underline', textUnderlineOffset: '3px', cursor: 'pointer' }}
                        >
                          Veja mais..
                        </span>
                      </div>
