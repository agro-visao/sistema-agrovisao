    ...
    <>
          ...
          <div style={{ maxWidth: '880px' }}>
            <div style={up(0.4)}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '18px', marginBottom: '32px' }}>
                ...
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#B8D48A', letterSpacing: '0.32em', textTransform: 'uppercase' }}>Portfólio · +100 Projetos Elaborados</span>
              </div>
            </div>
            <div style={up(0.62)}>
              <h1 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(43px, calc(5.6vw + 1px), 77px)', fontWeight: 300, color: '#F6F4EF', lineHeight: 1.06, letterSpacing: '-0.022em', marginBottom: '28px', textWrap: 'pretty' }}>
                Transformando Ideias em<br /><span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: 'clamp(37px, calc(4.8vw + 1px), 66px)', fontStyle: 'normal' }}>Projetos que Geram Impacto.</span>
              </h1>
            </div>
            <div style={up(0.84)}>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '17px', fontWeight: 500, color: 'rgba(246,244,239,0.80)', lineHeight: 1.80, maxWidth: '580px', marginBottom: '52px' }}>
            ...
            <div style={up(1.04)}>
              <div style={{ display: 'flex', gap: '14px', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <a
                  ...
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '14px 36px', color: '#F6F4EF', fontFamily: 'var(--font-sans)', fontSize: '12.5px', fontWeight: 500, letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '8px', border: '1px solid rgba(246,244,239,0.40)', transition: 'border-color 0.25s' }}
      ...
      <section style={{ background: '#FFFFFF', padding: '120px 0 100px' }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '72px' }} data-animate>
            ...
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Credenciais e Números</span>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', border: '1px solid rgba(49,91,44,0.10)', borderRadius: '16px', overflow: 'hidden', marginBottom: '32px' }} data-animate data-d="1">
            <div style={{ padding: '52px 44px', borderRight: '1px solid rgba(49,91,44,0.10)' }}>
              <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '77px', fontWeight: 300, color: '#315B2C', lineHeight: 1, marginBottom: '10px' }}>+100</div>
              <div style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.22em', textTransform: 'uppercase', lineHeight: 1.55, marginBottom: '14px' }}>Projetos<br />Elaborados</div>
              <div style={{ width: '24px', height: '2px', background: '#B8D48A' }} />
            </div>
            <div style={{ padding: '52px 44px', borderRight: '1px solid rgba(49,91,44,0.10)' }}>
              <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '77px', fontWeight: 300, color: '#315B2C', lineHeight: 1, marginBottom: '10px' }}>15+</div>
              <div style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.22em', textTransform: 'uppercase', lineHeight: 1.55, marginBottom: '14px' }}>Áreas de<br />Atuação</div>
              <div style={{ width: '24px', height: '2px', background: '#B8D48A' }} />
            </div>
            <div style={{ padding: '52px 44px', borderRight: '1px solid rgba(49,91,44,0.10)' }}>
              <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '77px', fontWeight: 300, color: '#315B2C', lineHeight: 1, marginBottom: '10px' }}>∞</div>
              <div style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.22em', textTransform: 'uppercase', lineHeight: 1.55, marginBottom: '14px' }}>Municípios<br />Atendidos</div>
              <div style={{ width: '24px', height: '2px', background: '#B8D48A' }} />
            </div>
            <div style={{ padding: '52px 44px', background: '#315B2C' }}>
              <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '77px', fontWeight: 300, color: '#F6F4EF', lineHeight: 1, marginBottom: '10px' }}>10+</div>
              <div style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', fontWeight: 600, color: '#B8D48A', letterSpacing: '0.22em', textTransform: 'uppercase', lineHeight: 1.55, marginBottom: '14px' }}>Anos de<br />Experiência</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '32px 40px', background: '#F5F8F3', borderRadius: '14px', border: '1px solid rgba(49,91,44,0.08)', flexWrap: 'wrap', gap: '24px' }} data-animate data-d="2">
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '4px' }}>Empresa Registrada</div>
                <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '19px', fontWeight: 400, color: '#1a1a18', letterSpacing: '0.04em' }}>CNPJ: 55.818.360/0001-33</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '4px' }}>Instagram Oficial</div>
                <a href="https://www.instagram.com/visaogestaodeprojetos/" target="_blank" rel="noopener noreferrer" style={{ fontFamily: "'Barlow', sans-serif", fontSize: '19px', fontWeight: 400, color: '#1a1a18', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => { e.currentTarget.style.color = '#315B2C' }} onMouseLeave={(e) => { e.currentTarget.style.color = '#1a1a18' }}>@visaogestaodeprojetos</a>
              </div>
            </div>
            <div style={{ width: '1px', height: '44px', background: 'rgba(49,91,44,0.12)' }} />
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '4px' }}>Consultoria Técnica</div>
                <a href="https://api.whatsapp.com/send?phone=5591982064340" target="_blank" rel="noopener noreferrer" style={{ fontFamily: "'Barlow', sans-serif", fontSize: '19px', fontWeight: 400, color: '#1a1a18', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => { e.currentTarget.style.color = '#315B2C' }} onMouseLeave={(e) => { e.currentTarget.style.color = '#1a1a18' }}>(91) 98206-4340</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '104px', alignItems: 'center' }}>
            <div data-animate>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '22px' }}>
                <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Nossa Experiência</span>
              </div>
              <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(37px, calc(3.8vw + 1px), 55px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.1, letterSpacing: '-0.018em', marginBottom: '26px', textWrap: 'pretty' }}>
                Do planejamento<br />à execução<br /><span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: 'clamp(32px, calc(3.3vw + 1px), 47px)', color: '#315B2C', fontStyle: 'normal' }}>completa</span>.
              </h2>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15.5px', fontWeight: 400, color: '#4a4a44', lineHeight: 1.9, marginBottom: '44px', maxWidth: '460px' }}>
                ...
                {[
                  ...
                  <div key={s.num} style={{ display: 'flex', alignItems: 'flex-start', gap: '18px', padding: '18px 0', borderBottom: s.num === '5' ? 'none' : '1px solid rgba(49,91,44,0.09)' }}>
                    <div style={{ width: '30px', height: '30px', border: '1.5px solid #315B2C', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                      <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: '14px', fontWeight: 500, color: '#315B2C' }}>{s.num}</span>
                    </div>
                    <div>
                      <div style={{ fontFamily: 'var(--font-sans)', fontSize: '12.5px', fontWeight: 700, color: '#315B2C', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '4px' }}>{s.title}</div>
                      <div style={{ fontFamily: 'var(--font-sans)', fontSize: '14px', fontWeight: 400, color: '#666660', lineHeight: 1.7 }}>{s.desc}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div style={{ position: 'relative' }} data-animate data-d="2">
              ...
              <div style={{ position: 'absolute', bottom: '-28px', left: '-28px', background: '#315B2C', borderRadius: '14px', padding: '24px 30px', boxShadow: '0 16px 48px rgba(0,0,0,0.2)' }}>
                <div style={{ fontFamily: "'Barlow', sans-serif", fontSize: '41px', fontWeight: 300, color: '#F6F4EF', lineHeight: 1, marginBottom: '6px' }}>100<span style={{ fontSize: '23px', color: '#B8D48A' }}>+</span></div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 600, color: '#B8D48A', letterSpacing: '0.2em', textTransform: 'uppercase' }}>Projetos Aprovados</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div style={{ textAlign: 'center', marginBottom: '72px' }} data-animate>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', marginBottom: '22px' }}>
              <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Áreas de Atuação</span>
              <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
            </div>
            <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(39px, calc(4.2vw + 1px), 59px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.1, letterSpacing: '-0.018em', marginBottom: '18px' }}>Categorias de Projetos</h2>
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '16px', fontWeight: 400, color: '#666660', lineHeight: 1.8, maxWidth: '520px', margin: '0 auto' }}>Atuamos em múltiplas frentes do desenvolvimento sustentável, social e econômico para a Amazônia Legal.</p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '14px' }} data-animate data-d="1">
            {projectCategories.map((cat) => (
              <div key={cat.key} style={{ background: '#FFFFFF', border: '1px solid rgba(49,91,44,0.12)', borderRadius: '14px', padding: '30px 20px', textAlign: 'center', boxShadow: '0 2px 10px rgba(0,0,0,0.04)' }}>
                ...
                <h3 style={{ fontFamily: "'Barlow', sans-serif", fontSize: '18px', fontWeight: 500, color: '#1a1a18', lineHeight: 1.3, marginBottom: '8px' }}>{cat.label}</h3>
      ...
      <section style={{ background: '#F5F8F3', padding: '140px 0', borderTop: '1px solid rgba(49,91,44,0.07)' }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '80px' }} data-animate>
            <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Projetos em Destaque</span>
          </div>
            ...
            <div key={idx} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center', marginBottom: idx < highlightProjects.length - 1 ? '120px' : '0' }} data-animate>
              {!h.reversed ? (
                <>
                  ...
                  <div>
                    <span style={{ display: 'inline-block', fontFamily: 'var(--font-sans)', fontSize: '10.5px', fontWeight: 700, color: '#315B2C', letterSpacing: '0.22em', textTransform: 'uppercase', background: 'rgba(49,91,44,0.08)', padding: '6px 14px', borderRadius: '4px', marginBottom: '26px' }}>{h.tag}</span>
                    <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(31px, calc(3.2vw + 1px), 45px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.12, letterSpacing: '-0.015em', marginBottom: '18px', textWrap: 'pretty' }}>{h.title}</h2>
                    <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', fontWeight: 400, color: '#4a4a44', lineHeight: 1.85, marginBottom: '28px' }}>{h.desc}</p>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '32px' }}>
                      {h.items.map((item, i) => (
                        <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                          ...
                          <span style={{ fontFamily: 'var(--font-sans)', fontSize: '14.5px', fontWeight: 400, color: '#555550', lineHeight: 1.65 }}>{item}</span>
                        </div>
                      ))}
                    </div>
                    <a
                      href="#"
                      onClick={(e) => { e.preventDefault(); openModal() }}
                      style={{ display: 'inline-block', padding: '13px 32px', background: '#315B2C', color: '#F6F4EF', fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 600, letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '8px', transition: 'background 0.25s' }}
                      onMouseEnter={(e) => { e.currentTarget.style.background = '#254822' }}
                      onMouseLeave={(e) => { e.currentTarget.style.background = '#315B2C' }}
                    >
      ...
      <section id="projetos-logos" style={{ background: '#FFFFFF', padding: '140px 0' }}>
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div style={{ textAlign: 'center', marginBottom: '56px' }} data-animate>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', marginBottom: '22px' }}>
              <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Portfólio Institucional</span>
              <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
            </div>
            <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(39px, calc(4.2vw + 1px), 59px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.1, letterSpacing: '-0.018em', marginBottom: '18px' }}>Projetos Desenvolvidos</h2>
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '16px', fontWeight: 400, color: '#666660', lineHeight: 1.8, maxWidth: '520px', margin: '0 auto' }}>Filtre por categoria e clique em um projeto para conhecer os detalhes. Mais de vinte iniciativas realizadas na Amazônia Legal.</p>
          </div>
                ...
                filtered.map((p) => (
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 600, color: '#1a1a18', lineHeight: 1.3 }}>{p.name}</div>
                      <div style={{ fontFamily: 'var(--font-sans)', fontSize: '10px', fontWeight: 600, color: '#6F8F3A', letterSpacing: '0.1em', textTransform: 'uppercase', marginTop: '4px' }}>{p.catLabel}</div>
                    </div>
                  </div>
                ))
              ) : (
                <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '60px 0' }}>
                  <p style={{ fontFamily: 'var(--font-sans)', fontSize: '17px', color: '#888882' }}>Nenhum projeto encontrado nesta categoria.</p>
                </div>
              )
            ) : (
              <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '60px 0' }}>
                ...
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', color: '#888882' }}>Carregando projetos...</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '56px' }} data-animate>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px' }}>
                <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Atividades de Campo</span>
              </div>
              <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(39px, calc(4.2vw + 1px), 57px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.1, letterSpacing: '-0.018em' }}>Projetos em Ação</h2>
            </div>
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', fontWeight: 400, color: '#666660', lineHeight: 1.8, maxWidth: '340px', marginBottom: '6px' }}>Visitas técnicas, capacitações, construções e atividades comunitárias desenvolvidas em campo pela equipe AgroVisão.</p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(0deg, rgba(6,14,4,0.4) 0%, rgba(6,14,4,0.05) 60%, transparent 100%)', display: 'flex', alignItems: 'flex-end', padding: '18px' }}>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: '12px', fontWeight: 600, color: '#F6F4EF', letterSpacing: '0.14em', textTransform: 'uppercase' }}>{g.label}</span>
                  </div>
                </div>
              )
            })}
        ...
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div style={{ textAlign: 'center', marginBottom: '80px' }} data-animate>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', marginBottom: '22px' }}>
              ...
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#B8D48A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Nossa Metodologia</span>
              <div style={{ width: '34px', height: '1px', background: '#B8D48A' }} />
            </div>
            <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(37px, calc(4.2vw + 1px), 57px)', fontWeight: 300, color: '#F6F4EF', lineHeight: 1.1, letterSpacing: '-0.018em' }}>
              Como desenvolvemos<br /><span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: 'clamp(32px, calc(3.6vw + 1px), 49px)', color: '#B8D48A', fontStyle: 'normal' }}>cada projeto</span>
            </h2>
          </div>
                ...
                <div key={step.num} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '0 8px' }}>
                  <div style={{
                    ...
                    {step.check ? (
                      ...
                      <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: '21px', fontWeight: 400, color: '#F6F4EF' }}>{step.num}</span>
                    )}
                  </div>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 700, color: '#B8D48A', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: '8px' }}>{step.title}</div>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '13px', fontWeight: 500, color: 'rgba(246,244,239,0.55)', lineHeight: 1.6 }}>{step.desc}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 84px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '100px', alignItems: 'center' }}>
            <div data-animate>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '22px' }}>
                <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Diferenciais</span>
              </div>
              <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(37px, calc(3.8vw + 1px), 53px)', fontWeight: 400, color: '#1a1a18', lineHeight: 1.1, letterSpacing: '-0.018em', marginBottom: '26px', textWrap: 'pretty' }}>
                Por que escolher<br />a <span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: 'clamp(32px, calc(3.3vw + 1px), 45px)', color: '#315B2C', fontStyle: 'normal' }}>AgroVisão</span>?
              </h2>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '16px', fontWeight: 400, color: '#4a4a44', lineHeight: 1.9, marginBottom: '44px', maxWidth: '420px' }}>Equipe multidisciplinar com profundo conhecimento do território amazônico, das políticas públicas e das exigências legais vigentes.</p>
              <a
                href="#"
                onClick={(e) => { e.preventDefault(); openModal() }}
                style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '15px 36px', background: '#315B2C', color: '#F6F4EF', fontFamily: 'var(--font-sans)', fontSize: '12.5px', fontWeight: 600, letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '8px', transition: 'background 0.25s' }}
                onMouseEnter={(e) => { e.currentTarget.style.background = '#254822' }}
                onMouseLeave={(e) => { e.currentTarget.style.background = '#315B2C' }}
              >
              ...
              {differentiators.map((d, idx) => (
                <div key={idx} style={{ padding: '26px 22px', background: d.dark ? '#315B2C' : '#FAFAF8', border: `1px solid ${d.dark ? '#315B2C' : 'rgba(49,91,44,0.08)'}` }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                    ...
                    <h4 style={{ fontFamily: 'var(--font-sans)', fontSize: '12px', fontWeight: 700, color: d.dark ? '#F6F4EF' : '#1a1a18', letterSpacing: '0.08em', textTransform: 'uppercase' }}>{d.title}</h4>
                  </div>
                  <p style={{ fontFamily: 'var(--font-sans)', fontSize: '14px', fontWeight: 400, color: d.dark ? 'rgba(246,244,239,0.75)' : '#666660', lineHeight: 1.65 }}>{d.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section style={{ background: '#F5F8F3', padding: '148px 0', borderTop: '1px solid rgba(49,91,44,0.07)' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 84px', textAlign: 'center' }} data-animate>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', marginBottom: '22px' }}>
            <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: '11.5px', fontWeight: 500, color: '#6F8F3A', letterSpacing: '0.24em', textTransform: 'uppercase' }}>Vamos Conversar</span>
            <div style={{ width: '34px', height: '1px', background: '#315B2C' }} />
          </div>
          <h2 style={{ fontFamily: "'Barlow', sans-serif", fontSize: 'clamp(41px, calc(4.8vw + 1px), 67px)', fontWeight: 300, color: '#1a1a18', lineHeight: 1.08, letterSpacing: '-0.02em', marginBottom: '22px', textWrap: 'pretty' }}>
            Vamos transformar sua ideia em um<br /><span style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 600, fontSize: 'clamp(35px, calc(4.1vw + 1px), 57px)', color: '#315B2C', fontStyle: 'normal' }}>projeto de sucesso</span>.
          </h2>
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: '16px', fontWeight: 400, color: '#4a4a44', lineHeight: 1.85, marginBottom: '52px', maxWidth: '500px', marginLeft: 'auto', marginRight: 'auto' }}>Nossa equipe técnica está pronta para analisar seu contexto e estruturar a solução ideal para o seu projeto rural ou ambiental.</p>
          <div style={{ display: 'flex', gap: '14px', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a
              href="#"
              onClick={(e) => { e.preventDefault(); openModal() }}
              style={{ display: 'inline-block', padding: '16px 44px', background: '#315B2C', color: '#F6F4EF', fontFamily: 'var(--font-sans)', fontSize: '12.5px', fontWeight: 600, letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '8px', transition: 'background 0.25s' }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#254822' }}
              onMouseLeave={(e) => { e.currentTarget.style.background = '#315B2C' }}
            >
              Solicitar Consultoria
            ...
            <a
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '15px 40px', color: '#315B2C', fontFamily: 'var(--font-sans)', fontSize: '12.5px', fontWeight: 500, letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '8px', border: '1.5px solid rgba(49,91,44,0.28)', transition: 'border-color 0.25s, background 0.25s' }}
            ...
            {mSts !== 'success' ? (
              <form onSubmit={submitForm} style={{ padding: '32px 44px 44px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', padding: '16px', background: '#F8F7F3', borderRadius: '8px', marginBottom: '28px' }}>
                  ...
                  <label htmlFor="p-prv" style={{ fontFamily: 'var(--font-sans)', fontSize: '14px', fontWeight: 400, color: '#555550', lineHeight: 1.65, cursor: 'pointer' }}>
