          ...
          <div className="nav-links">
            ...
            <a
              ...
              style={{
                ...
                textTransform: 'uppercase',
                textShadow: navTextShadow,
                borderBottom: isActivePrefix('/projetos') ? '1px solid currentColor' : 'none',
                paddingBottom: '2px',
              }}
            >
              Projetos
            ...
            <a
              ...
              style={{
                ...
                textTransform: 'uppercase',
                textShadow: navTextShadow,
                borderBottom: isActivePrefix('/vendas') ? '1px solid currentColor' : 'none',
                paddingBottom: '2px',
              }}
            >
              Vendas
            ...
            <a
              ...
              style={{
                ...
                textTransform: 'uppercase',
                textShadow: navTextShadow,
                borderBottom: isActive('/contato') ? '1px solid currentColor' : 'none',
                paddingBottom: '2px',
              }}
            >
              Contato
